...
This folder contains the local browser interface for PIXEL.
...
- When a checkpoint exists, PIXEL rebuilds the model from the checkpoint's saved metadata.
...
- `400 Unknown PIXEL preset`: the requested `size` is not one of `100m`, `1b`, `3b`, `7b`.
